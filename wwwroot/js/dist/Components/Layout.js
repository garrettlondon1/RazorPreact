...
(() => {
  ...
  function I(n2, l2, t2, u3, i3, r2, o2, e2, f3, c2, s2) {
    var a2, h2, y2, d2, w2, g2, _ = u3 && u3.__k || v, m2 = l2.length;
    for (f3 = P(t2, l2, _, f3, m2), a2 = 0; a2 < m2; a2++) null != (y2 = t2.__k[a2]) && (h2 = -1 === y2.__i ? p : _[y2.__i] || p, y2.__i = a2, g2 = O(n2, y2, h2, i3, r2, o2, e2, f3, c2, s2), d2 = y2.__e, y2.ref && h2.ref != y2.ref && (h2.ref && q(h2.ref, null, y2), s2.push(y2.ref, y2.__c || d2, y2)), null == w2 && null != d2 && (w2 = d2), 4 & y2.__u || h2.__k === y2.__k ? f3 = A(y2, f3, n2) : "function" == typeof y2.type && void 0 !== g2 ? f3 = g2 : d2 && (f3 = d2.nextSibling), y2.__u &= -7);
    return t2.__e = w2, f3;
  }
  ...
  function O(n2, t2, u3, i3, r2, o2, e2, f3, c2, s2) {
    var a2, h2, p2, v2, y2, _, m2, b, S2, C2, M2, $2, P2, A2, H, L2, T2, j2 = t2.type;
    ...
    n: if ("function" == typeof j2) try {
      ...
      h2.state = h2.__s, null != h2.getChildContext && (i3 = w(w({}, i3), h2.getChildContext())), S2 && !p2 && null != h2.getSnapshotBeforeUpdate && (_ = h2.getSnapshotBeforeUpdate(v2, y2)), L2 = a2, null != a2 && a2.type === k && null == a2.key && (L2 = N(a2.props.children)), f3 = I(n2, d(L2) ? L2 : [L2], t2, u3, i3, r2, o2, e2, f3, c2, s2), h2.base = t2.__e, t2.__u &= -161, h2.__h.length && e2.push(h2), m2 && (h2.__E = h2.__ = null);
    } catch (n3) {
  ...
  function V(t2, u3, i3, r2, o2, e2, f3, c2, s2) {
    var a2, h2, v2, y2, w2, _, m2, b = i3.props, k2 = u3.props, x2 = u3.type;
    ...
    if (null === x2) b === k2 || c2 && t2.data === k2 || (t2.data = k2);
      ...
      for (a2 in k2) w2 = k2[a2], "children" == a2 ? y2 = w2 : "dangerouslySetInnerHTML" == a2 ? h2 = w2 : "value" == a2 ? _ = w2 : "checked" == a2 ? m2 = w2 : c2 && "function" != typeof w2 || b[a2] === w2 || j(t2, a2, w2, b[a2], o2);
      ...
      c2 || (a2 = "value", "progress" == x2 && null == _ ? t2.removeAttribute("value") : void 0 !== _ && (_ !== t2[a2] || "progress" == x2 && !_ || "option" == x2 && _ !== b[a2]) && j(t2, a2, _, b[a2], o2), a2 = "checked", void 0 !== m2 && m2 !== t2[a2] && j(t2, a2, m2, b[a2], o2));
    }
    return t2;
  }
  function q(n2, t2, u3) {
